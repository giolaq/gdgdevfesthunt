...
import com.laquysoft.droidconnl.estimote.BeaconClue;
import com.laquysoft.droidconnl.estimote.BeaconHuntManager;
import com.laquysoft.droidconnl.estimote.NearableID;
...
public class ClueActivity extends BaseActivity {
    ...
    private final static String LOG_TAG = ClueActivity.class.getSimpleName();
    ...
    private BeaconHuntManager beaconHuntManager;
    ...
    private Map<NearableID, BeaconClue> beaconClueHashMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        beaconClueHashMap = new HashMap<>();

        beaconHuntManager = new BeaconHuntManager(this, beaconClueHashMap);
        beaconHuntManager.setListener(new BeaconHuntManager.Listener() {
            Hunt hunt = getHunt();

            @Override
            public void onBeaconCluePickup(BeaconClue beaconClue) {
                Log.d(LOG_TAG, "onBeaconCluePickup: ");
            }

            @Override
            public void onBeaconCluePutdown(BeaconClue beaconClue) {
                Log.d(LOG_TAG, "onBeaconCluePutdown: ");
                Clue clue = hunt.getCurrentClue();
                updateTagDisplay(hunt, clue);
                hunt.soundManager.play(hunt.soundManager.foundIt, mContext );
                hunt.achievementManager.onNewTagScanned(
                        hunt.getClueIndex(clue), getApiClient(), mContext);
            }

            @Override
            public void onBeaconClueHeatOn(BeaconClue beaconClue) {
                Log.d(LOG_TAG, "onBeaconClueHeatOn: ");
            }

            @Override
            public void onBeaconClueCoolDown(BeaconClue beaconClue) {
                Log.d(LOG_TAG, "onBeaconClueCoolDown: ");
            }
        });
    ...
    public void refresh() {
        ...
        beaconClueHashMap.put(new NearableID("d8f669a56e9a1f3b"), new BeaconClue("Sweeft Headphones",
        ...
        beaconClueHashMap.put(new NearableID("b9f69505fb5d2c5a"), new BeaconClue("Nyan Bicycle 3x14",
...
//				"AppyDays Hunt: Clue #" + clueNumber + " of " + totalClues);
    ...
    public void onResume() {
        ...
        if (!SystemRequirementsChecker.checkWithDefaultDialogs(this)) {
            ...
            beaconHuntManager.startUpdates();
        }
    ...
    protected void onPause() {
        ...
        beaconHuntManager.stopUpdates();
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        beaconHuntManager.destroy();
    }
}
