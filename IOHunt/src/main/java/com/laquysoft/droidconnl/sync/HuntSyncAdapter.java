...
public class HuntSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = HuntSyncAdapter.class.getSimpleName();
    ...
    public HuntSyncAdapter(Context context, boolean autoInitialize) {
    ...
    static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        HuntSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
