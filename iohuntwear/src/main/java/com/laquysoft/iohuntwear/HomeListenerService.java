...
public class HomeListenerService extends WearableListenerService
    ...
    private static final String TAG = HomeListenerService.class.getName();
    ...
    public final static String ACTION_DISMISS
            = "com.laquysoft.iohuntwear.ACTION_DISMISS";
    public final static String ACTION_START_FEEDBACK
            = "com.laquysoft.iohuntwear.ACTION_FEEDBACK";
    public static final String PATH_FEEDBACK = "/gdghunt";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (null != intent) {
            ...
            if (ACTION_DISMISS.equals(action)) {
                ...
                Log.d(TAG, "onStartCommand(): Action: ACTION_DISMISS Session: " + sessionId);
                ...
                Log.d(TAG, "Received session id from data layer: " + sessionId);
    ...
    private void dismissPhoneNotification(final String sessionId) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG, "dismissPhoneNotification(): Dismiss wearable notification");
                if (mGoogleApiClient.isConnected()) {
                    Log.d(TAG, "Deleting Uri is: " + putDataMapRequest.getUri().toString());
                            ...
                            .setResultCallback(new ResultCallback<DataApi.DeleteDataItemsResult>() {
                                ...
                                public void onResult(
                                    ...
                                    if (!deleteDataItemsResult.getStatus().isSuccess()) {
                                        Log.d(TAG, "dismissPhoneNotification(): failed to delete"
                                                + " the data item");
                                    }
                                }
                            });
    ...
    private void setupNotification(DataItem dataItem) {
        ...
        String sessionName = dataMap.getString("name");
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("controlla i tuoi punti")
